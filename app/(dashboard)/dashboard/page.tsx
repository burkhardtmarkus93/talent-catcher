...
export default async function DashboardPage() {
  ...
  const highAlerts = urgent.filter((talent) => talent.currentAlert?.riskLevel === "rot").length;
            ...
            <p className="mt-1 font-display text-3xl font-medium text-ink">
              {highAlerts > 0 ? (
                <>
                  ...
                  {t("talentsNeedAttention", { count: highAlerts })}
                </>
              ) : (
                t("noUrgentAlerts")
              )}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted">
                        {talent.primaryPosition} · {talent.clubNameText}
                      </p>
                    </div>
