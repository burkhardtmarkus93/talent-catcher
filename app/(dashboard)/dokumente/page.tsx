...
export default async function DokumentePage() {
  ...
  return (
    <div>
      <PageHeader
        title="Dokumente"
        subtitle="Word-Dateien zum direkten Download"
        icon={
      ...
      <div className="flex flex-col gap-3">
        <div className="flex flex-col gap-4 rounded-xl border border-line bg-surface p-5 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-base font-medium text-ink">
                Koordinationstest – Tests und Bewertung
              </h2>
            ...
            <p className="mt-2 text-sm text-muted">
              Word-Datei mit allen Koordinationstests, Punkteskala 0–3,
              Info-Icon-Texten und Bild-Skizzen.
            </p>
          </div>
          ...
          {koordinationstestUrl ? (
            ...
            <p className="text-sm text-brick">Datei aktuell nicht verfügbar.</p>
          )}
        </div>
      </div>
    </div>
